...
public class Warrior extends RaidTheStockades {
    ...
    public void intro(Player player) {
        ...
        saluteOrScoff(player, entry);
    }

    public void saluteOrScoff(Player player, String entry) {
    ...
    public void moveOutOrNot(Player player, String entry) {
        do {
            entry = input.nextLine();
            if (playerChoice("1", entry) || playerChoice("move out", entry)) {
                ...
                entry = input.nextLine();
                toStocksOrToWander(player, entry);
    ...
    public void toStocksOrToWander(Player player, String entry) {
    ...
    public void toChargeOrToWait(Player player, String entry) {
        if (playerChoice("1", entry)) {
